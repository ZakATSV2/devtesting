...
function syde:AddDrag(Object, Main, ConstrainToParent)
	...
	local function getConstrainedPosition(newPos)
		...
		if ConstrainToParent and Main.Parent and Main.Parent:IsA("GuiObject") then
			local parentSize = Main.Parent.AbsoluteSize
			local frameSize = Main.AbsoluteSize

			minX, maxX = 0, parentSize.X - frameSize.X
			minY, maxY = 0, parentSize.Y - frameSize.Y

		elseif LockToScreen then
			local screenSize = workspace.CurrentCamera.ViewportSize
			local frameSize = Main.AbsoluteSize

			minX, maxX = 0, screenSize.X - frameSize.X
			minY, maxY = 0, screenSize.Y - frameSize.Y
...
function syde:Modal(Modal)
	task.spawn(function()
		...
		ModalInstance.Size = UDim2.new(0, ModalInstance.Size.X.Offset, 0, ModalInstance.Content.TextBounds.Y + 150)
...
do
	...
	function syde:Load(Config)
		...
		local statusColors = {
			Stable = { Color = Color3.fromRGB(25, 229, 22), Text = '<font color="#24bf48">Stable Release</font>' },
			Unstable = { Color = Color3.fromRGB(227, 229, 81), Text = '<font color="#e3e551">Unstable Release</font>' },
			Testing = { Color = Color3.fromRGB(6, 85, 227), Text = '<font color="#0655e3">Testing Build</font>' },
